...
> - No están todas las asignaturas obligatorias y básicas, ya que convalidé las siguientes por haber superado el CFGS en [Desarrollo de Aplicaciones Web](https://github.com/HenestrosaDev/2-daw) (y Multiplataforma), el [Curso de Especialización en Ciberseguridad en Entornos de las Tecnologías de la Información](https://github.com/HenestrosaDev/curso-especializacion-ciberseguridad-ti) y obtener el título C1 de inglés de Cambridge (CAE):
>
