...
\begin{document}
    ...
    \begin{enumerate}[label=\alph*)] 
        ...
        { \color{blue} 
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=13cm]{imagenes_entrega/1a.png}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=13cm]{imagenes_entrega/1a-lambda.png}
    ...
    \begin{problem}[Cuestión 2]
        ...
        \begin{enumerate}[label=\alph*)]
            ...
            { \color{blue} 
               ...
               \begin{figure}[H]
                    \centering
                    \includegraphics[width=10cm]{imagenes_entrega/2b.png}
        ...
        \begin{enumerate}[label=\alph*)]
            ...
            { \color{blue} 
                \begin{itemize}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=13cm]{imagenes_entrega/5a-interferencia.png}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=13cm]{imagenes_entrega/5a-difraccion.png}
                    ...
                    \begin{figure}[H]
                        \centering
                        \includegraphics[width=13cm]{imagenes_entrega/5a-both.png}
            ...
            { \color{blue} 
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=13cm]{imagenes_entrega/5b-a10.png}
                    \caption{Solo interferencia con el valor $a = 10 \; \mu \text{m}$}
                \end{figure}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=13cm]{imagenes_entrega/5b-a1.png}
            ...
            { \color{blue} 
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=13cm]{imagenes_entrega/5c.png}
            ...
            { \color{blue} 
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=13cm]{imagenes_entrega/5d-rendija-ancha.png}
                ...
                \begin{figure}[H]
                    \centering
                    \includegraphics[width=13cm]{imagenes_entrega/5d-rendija-estrecha.png}
    ...
    \begin{problem}[Problema]
        ...
        \begin{enumerate}[label=\alph*)]
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=13cm]{imagenes_entrega/problema.jpg}
