...
(defun BtoC (estado info)
  (if (equal estado 'B) 'C 'vacio))
(defun BtoD (estado info)
  (if (equal estado 'B) 'D 'vacio))
(defun BtoE (estado info)
  (if (equal estado 'B) 'E 'vacio))
(defun CtoD (estado info)
  (if (equal estado 'C) 'D 'vacio))
