...
public class ItemRepositoryImpl implements ItemRepository {
	...
	public String createItem(Item item) {
		...
		itemEntity.setProduct(jpaProductRepository.findById(item.getProductId()).orElseThrow(() -> new edu.uoc.epcsd.productcatalog.domain.service.ProductNotFoundException(item.getProductId())));
