...
public class ItemServiceImpl implements ItemService {
	...
	public Item setOperational(String serialNumber, boolean operational) {
		...
		Item item = itemRepository.findBySerialNumber(serialNumber).orElseThrow(() -> new edu.uoc.epcsd.productcatalog.domain.service.ItemNotFoundException(serialNumber));
