...
public class AlertRESTController {
	...
	public ResponseEntity<Long> createAlert(@RequestBody @Valid CreateAlertRequest createAlertRequest) {
		...
		} catch (edu.uoc.epcsd.user.domain.exception.UserNotFoundException e) {
			throw new ResponseStatusException(HttpStatus.NOT_FOUND, "The specified userId " + createAlertRequest.getUserId() + " does not exist.", e);
