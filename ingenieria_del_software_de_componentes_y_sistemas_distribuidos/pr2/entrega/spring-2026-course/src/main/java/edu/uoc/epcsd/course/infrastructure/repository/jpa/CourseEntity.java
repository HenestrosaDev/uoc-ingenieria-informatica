...
public class CourseEntity implements DomainTranslatable<Course> {
	...
	public void updateDetailsFrom(Course course) {
		...
		this.mode = course.getMode();
		this.price = course.getPrice();
		this.objectives = course.getObjectives();
		this.methology = course.getMethology(); // Recuerda corregir a methodology ;)
		this.duration = course.getDuration();
		this.language = course.getLanguage();
		this.location = course.getLocation();
		// Note: We intentionally exclude 'id', 'status', and 'enrollment' from being updated here, as they are managed separately.
	}
}
